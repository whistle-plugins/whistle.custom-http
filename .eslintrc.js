module.exports = {
  ...
  rules: {
    ...
    "eol-last": [2, "always"], // 要求或禁止文件末尾存在空行
    ...
    "import/order": ["error", {"groups": ["builtin", "external", "internal", "parent", "sibling", "index"]}], // import引入按照一定顺序
    "import/no-default-export": 0, // 不允许defalut export  --CUSTOM
